...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2d650513          	addi	a0,a0,726 # 1370 <malloc+0xe4>
      a2:	00001097          	auipc	ra,0x1
      a6:	e1c080e7          	jalr	-484(ra) # ebe <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2c650513          	addi	a0,a0,710 # 1370 <malloc+0xe4>
      b2:	00001097          	auipc	ra,0x1
      b6:	e14080e7          	jalr	-492(ra) # ec6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2bc50513          	addi	a0,a0,700 # 1378 <malloc+0xec>
  ...
  chdir("/");
      ...
      da:	2c250513          	addi	a0,a0,706 # 1398 <malloc+0x10c>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2c298993          	addi	s3,s3,706 # 13a8 <malloc+0x11c>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2b098993          	addi	s3,s3,688 # 13a0 <malloc+0x114>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     10c:	2a850513          	addi	a0,a0,680 # 13b0 <malloc+0x124>
    ...
    if(what == 1){
     ...
     292:	34258593          	addi	a1,a1,834 # 15d0 <malloc+0x344>
     ...
     2b6:	37650513          	addi	a0,a0,886 # 1628 <malloc+0x39c>
     ...
     2d4:	0f050513          	addi	a0,a0,240 # 13c0 <malloc+0x134>
     ...
     35c:	08850513          	addi	a0,a0,136 # 13e0 <malloc+0x154>
     ...
     37e:	07650513          	addi	a0,a0,118 # 13f0 <malloc+0x164>
     ...
     4b4:	fc050513          	addi	a0,a0,-64 # 1470 <malloc+0x1e4>
     ...
     502:	f7250513          	addi	a0,a0,-142 # 1470 <malloc+0x1e4>
     ...
     55e:	f2e50513          	addi	a0,a0,-210 # 1488 <malloc+0x1fc>
     ...
     58a:	eca50513          	addi	a0,a0,-310 # 1450 <malloc+0x1c4>
     ...
     5ac:	ec850513          	addi	a0,a0,-312 # 1470 <malloc+0x1e4>
     ...
     5c6:	ed650513          	addi	a0,a0,-298 # 1498 <malloc+0x20c>
     ...
     614:	e6050513          	addi	a0,a0,-416 # 1470 <malloc+0x1e4>
     ...
     670:	e4450513          	addi	a0,a0,-444 # 14b0 <malloc+0x224>
     ...
     69c:	e3058593          	addi	a1,a1,-464 # 14c8 <malloc+0x23c>
     ...
     79e:	cd650513          	addi	a0,a0,-810 # 1470 <malloc+0x1e4>
     ...
     7e4:	ce858593          	addi	a1,a1,-792 # 14c8 <malloc+0x23c>
     ...
     856:	cde50513          	addi	a0,a0,-802 # 1530 <malloc+0x2a4>
     ...
     870:	cdc50513          	addi	a0,a0,-804 # 1548 <malloc+0x2bc>
     ...
     88c:	cd850513          	addi	a0,a0,-808 # 1560 <malloc+0x2d4>
     ...
     8a6:	ce650513          	addi	a0,a0,-794 # 1588 <malloc+0x2fc>
     ...
     8c0:	bf458593          	addi	a1,a1,-1036 # 14b0 <malloc+0x224>
     8c4:	4509                	li	a0,2
     ...
     8dc:	bd858593          	addi	a1,a1,-1064 # 14b0 <malloc+0x224>
     8e0:	4509                	li	a0,2
     ...
     938:	c7c58593          	addi	a1,a1,-900 # 15b0 <malloc+0x324>
     93c:	4509                	li	a0,2
     ...
     9ac:	ac858593          	addi	a1,a1,-1336 # 1470 <malloc+0x1e4>
     9b0:	4509                	li	a0,2
     ...
     9f8:	bbc58593          	addi	a1,a1,-1092 # 15b0 <malloc+0x324>
     9fc:	4509                	li	a0,2
     ...
     a3c:	b7858593          	addi	a1,a1,-1160 # 15b0 <malloc+0x324>
     a40:	4509                	li	a0,2
     ...
     aa4:	9d058593          	addi	a1,a1,-1584 # 1470 <malloc+0x1e4>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	98850513          	addi	a0,a0,-1656 # 1450 <malloc+0x1c4>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3d6080e7          	jalr	982(ra) # ea6 <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	92850513          	addi	a0,a0,-1752 # 1400 <malloc+0x174>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b10:	96450513          	addi	a0,a0,-1692 # 1470 <malloc+0x1e4>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b52:	92250513          	addi	a0,a0,-1758 # 1470 <malloc+0x1e4>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3e:	71e50513          	addi	a0,a0,1822 # 1658 <digits>
     f42:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    100a:	652b8b93          	addi	s7,s7,1618 # 1658 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    114a:	50a90913          	addi	s2,s2,1290 # 1650 <malloc+0x3c4>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1212:	46a7b783          	ld	a5,1130(a5) # 1678 <freep>
    ...
    1240:	00e6ea63          	bltu	a3,a4,1254 <free+0x50>
{
  ...
  freep = p;
    ...
    1282:	3ef73d23          	sd	a5,1018(a4) # 1678 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12b4:	3c853503          	ld	a0,968(a0) # 1678 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12dc:	3a090913          	addi	s2,s2,928 # 1678 <freep>
  if(p == (char*)-1)
    12e0:	5afd                	li	s5,-1
    12e2:	a88d                	j	1354 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12e4:	00000797          	auipc	a5,0x0
    12e8:	78478793          	addi	a5,a5,1924 # 1a68 <base>
    12ec:	00000717          	auipc	a4,0x0
    12f0:	38f73623          	sd	a5,908(a4) # 1678 <freep>
    ...
    1316:	36a73323          	sd	a0,870(a4) # 1678 <freep>
      return (void*)(p + 1);
